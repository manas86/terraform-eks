...
Right now the region is "eu-west-1"
...
kubectl get pods
```
Now connect the pods with LOADBALANCER
```
kubectl expose deloyment helloworld --type=loadBalancer
kubectl get services
kubectl describe service/helloworld
```
get the loadbalance dns name to connect and test
